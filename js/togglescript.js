...
$(document).ready(function(){
    ...
    $('#fullscreen2 img').click(function() {
        $('#fullscreen2 img').toggleClass('active');
    });
    ...
    if (document.documentElement.clientWidth < 767) {
        $('#thumbs, #home1, #home2, #home3, #home4, #home5, #home6, #home7, #home8, #home9, #home10, #home11, #home12').click(function(){
